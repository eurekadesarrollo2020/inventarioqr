...
use inventarioqr\Http\Requests;
use inventarioqr\Categoria;
use Illuminate\Support\Facades\Redirect;
use inventarioqr\Http\Requests\CategoriaFormRequest;
use DB;
   ...
   public function __construct()
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            $categorias=DB::table('categoria')->where('NOMBRE_CATEGORIA','LIKE','%'.$query.'%')
